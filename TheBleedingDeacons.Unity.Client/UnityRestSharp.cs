...
public sealed class UnityRestSharp : IDisposable
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await GetAsync<List<Group>>(url, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await GetAsync<Group>(url, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await GetAsync<List<Meeting>>(url, cancellationToken).ConfigureAwait(false);
    }
    ...
    public async Task<ApiResponse<Meeting>> GetMeetingAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        return await GetAsync<Meeting>(url, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await GetAsync<List<Position>>(url, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await GetAsync<Position>(url, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await GetAsync<List<Member>>(url, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await GetAsync<Member>(url, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await PostAsync<Member>(url, request, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await GetAsync<List<IntergroupMeeting>>(url, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await GetAsync<IntergroupMeeting>(url, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await PostAsync<IntergroupMeetingGroupRegistration>(url, payload, cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await PostAsync<IntergroupMeetingOfficerRegistration>(url, payload, cancellationToken).ConfigureAwait(false);
    }
    ...
    public async Task<HealthResponse?> CheckHealthAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            using var response = await SendWithRetryAsync(
                ...
                "GET", url, cancellationToken).ConfigureAwait(false);
    ...
    private async Task<ApiResponse<T>> PostAsync<T>(string url, object payload, CancellationToken cancellationToken) where T : class
    {
        ...
        try
        {
            ...
            using var response = await SendWithRetryAsync(
                ...
                "POST", url, cancellationToken).ConfigureAwait(false);
            statusCode = (int)response.StatusCode;
            var content = await response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            contentSnippet = content.Length > 500 ? content[..500] : content;
        ...
        for (int attempt = 1; attempt <= MaxRetryAttempts; attempt++)
        {
            ...
            try
            {
                ...
                else if (status == 403 && IsLikelyWafHtml(response))
                {
                    ...
                    try
                    {
                        var htmlBody = await response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        var headers = FormatHeaders(response.Headers);
                        var contentHeaders = FormatHeaders(response.Content.Headers);
                        _logger.LogWarning(
    ...
    private static int GetHeaderInt(HttpResponseMessage response, string headerName)
    {
        if (response.Headers.TryGetValues(headerName, out var values))
        {
            ...
            if (int.TryParse(value, System.Globalization.CultureInfo.InvariantCulture, out var result))
                return result;
        }
